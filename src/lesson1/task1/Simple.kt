 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = (sagenes*3*16*4.445+arshins*16*4.455+vershoks*4.445)/100
 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = (deg*60*60+min*60+sec)/3600*(PI/180)
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    val rate: Double = (percent+100)\100
    val ans: Double = (initial*rate*rate*rate)
    return ans
}
